...
export default function ImportPage() {
  ...
  return (
    <StudioShell
      ...
      description="Upload a question paper as PDF, Word or text. It is read in memory, parsed, and discarded — the file itself is never stored."
    >
        ...
        <Panel>
          ...
          <div className="px-5 py-4">
            <input
              ...
              className="block w-full text-[13.5px] text-ink-2 file:mr-3 file:rounded-md file:border file:border-line-strong file:bg-surface file:px-3 file:py-2 file:text-[13px] file:font-medium file:text-ink hover:file:bg-subtle"
            />
            {parsing ? (
            ...
            <details className="mt-4">
              ...
              <pre className="thin-scroll mt-2 overflow-x-auto rounded-md border border-line bg-subtle px-4 py-3 font-mono text-[12px] leading-relaxed text-ink-2">
                {TEMPLATE_SAMPLE}
              </pre>
              <p className="mt-2 text-[12.5px] text-ink-3">
                Numbering may be <code className="font-mono">1.</code>,{" "}
                <code className="font-mono">1)</code>, <code className="font-mono">Q1.</code> or{" "}
                <code className="font-mono">Q.1</code>; options may be{" "}
                <code className="font-mono">(A)</code>, <code className="font-mono">A)</code>,{" "}
                <code className="font-mono">A.</code> or lower case. The answer may be a letter, a
                number, or the option&apos;s own text. Explanation, topic and difficulty are
                optional.
              </p>
            </details>
          </div>
